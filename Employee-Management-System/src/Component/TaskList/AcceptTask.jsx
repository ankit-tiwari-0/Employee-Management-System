...
const AcceptTask = ({data}) => {
  ...
  background: "linear-gradient(135deg, #22c55e, #10b981, #06b6d4)"
        ...
        <div className='flex justify-between lg:mt-15 m-4'>
           <button className='bg-linear-to-br from-green-400 via-green-200 to-yellow-500 py-1 px-2 text-l rounded-xl active:scale-50 cursor-pointer transition-all duration-200 text-gray-700 font-semibold'> Completed</button> 
           <button className='bg-linear-to-br from-red-500 via-red-400 to-red-300 py-0.5 px-2 text-l rounded-xl active:scale-50 cursor-pointer font-semibold'> Failed</button> 
        </div>
        </div> 
  )
}
