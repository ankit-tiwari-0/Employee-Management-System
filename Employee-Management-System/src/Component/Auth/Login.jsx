...
const Login = ({handleLogin}) => {
  ...
  return (
    <div className='flex h-screen w-full lg:w-screen items-center justify-center '>
      <div className='border-2 rounded-4xl p-10 lg:p-20 h-1/2  border-emerald-600  '>
        <form onSubmit={(e) => {
          submitHandler(e)
        }}
          ...
          <button className='border-none lg:mt-5 mt-15 bg-emerald-500 rounded-full  text-white outline-none font-bold text-xl py-2 px-8 cursor-pointer active:scale-50 hover:bg-pink-300 hover:text-pink-100 ' >Log in</button>
        </form>
      </div>
